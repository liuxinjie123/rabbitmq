...
public class DirectRabbitConfig {
    ...
    @Value("${exchange.direct.lonely}")
    private String directExchangeLonely;
    ...
    Binding bindingDirect2() {
        return BindingBuilder.bind(TestDirectQueue2()).to(TestDirectExchange()).with(directRouteKey);
    }

    @Bean
    DirectExchange lonelyDirectExchange() {
        return new DirectExchange(directExchangeLonely);
    }
